...
> **Course:** NASM Anatomy, Physiology & Kinesiology for Fitness Professionals (Coursera)
> **Purpose:** Study notes for Tensegrity Cert IV RPL — A&P evidence equivalent to SISFFIT047
> **Student:** Shreya Kothari
...
| 7 | [[Biomechanics & Kinesiology/Biomechanics & Kinesiology\|Biomechanics & Kinesiology]] | Applied movement science — planes, muscle actions, levers, full squat analysis |
| 8 | [[Pilates Applications\|Pilates Applications]] | Pulls everything together through a Pilates teaching lens |

> [!tip] Using this for exam prep?
> Use [[Glossary|Glossary]] alongside any note — every key term links back to the section where it's explained. [[Pilates Applications#Key Exam Memorisation Tricks|Exam memory tricks]] are at the bottom of Pilates Applications.
...
- [[Cardiorespiratory System/Cardiorespiratory System|Cardiorespiratory System]] — heart, blood, lungs, gas exchange, breathing

### Applied Science
- [[Bioenergetics & Energy Systems/Bioenergetics & Energy Systems|Bioenergetics & Energy Systems]] — ATP pathways, programming applications
- [[Biomechanics & Kinesiology/Biomechanics & Kinesiology|Biomechanics & Kinesiology]] — planes of motion, muscle actions, levers, squat analysis

### Reference
- [[Glossary|Master Glossary]] — A–Z definitions for all key terms
- [[Pilates Applications|Pilates Applications]] — practical teaching applications + exam memory tricks

---

## Weekly Structure (Original Course)
...
Nervous System
     │ controls
     ▼
Muscular System ──► moves ──► Skeletal System
     ▲                              │
     └──────── proprioception ───────┘
                 (feedback)
```
...
#anatomy #physiology #kinesiology #nasm #pilates #tensegrity-rpl #sisffit047
