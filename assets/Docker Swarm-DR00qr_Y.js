...
➡️ Docker Swarm will **automatically restart** a new container to replace the killed one, so that the number of replicas (e.g., 3 or 5) is always maintained.`;export{e as default};
