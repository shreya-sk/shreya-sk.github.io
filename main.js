...
window.nextProject = function() {
    ...
    console.log('Next project function executed');
  };
  ...
  window.prevProject = function() {
    ...
    // Update counter if it exists
    if (counter) {
      counter.textContent = `${prevIndex + 1}/${slides.length}`;
    }
    
    console.log('Previous project function executed');
  };
  
  // Make sure we initialize on page load
