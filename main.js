...
window.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to update slide classes for the faded preview effect
    function updateSlideClasses() {
      ...
      // Set active slide
      slides[currentIndex].classList.add('active', 'rectangle-transition');
    ...
    window.nextProject = function() {
      ...
      if (nextBtn) {
        ...
        setTimeout(() => nextBtn.classList.remove('jelly-button'), 700);
      }
    ...
    window.prevProject = function() {
      ...
      if (prevBtn) {
        ...
        setTimeout(() => prevBtn.classList.remove('jelly-button'), 700);
      }
